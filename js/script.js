...
function addToCart(event){
  ...
  var itemprice =  event.target.parentElement.querySelector('.card-price').textContent;
  var itemtitle = event.target.parentElement.querySelector('.card-title').textContent;
